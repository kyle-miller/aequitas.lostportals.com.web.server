...
public class IconService_UT {
	...
	public void save_new_checkDaoCall() throws Exception {
		Icon toSave = new Icon(createDbIcon());
		toSave.setId(null);
	...
	public void save_new_daoFail() throws Exception {
		...
		when(iconDao.save(any(DbIcon.class))).thenThrow(new IllegalAccessException("something"));
